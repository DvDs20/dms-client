...
import { Button, Divider, Grid, InputLabel, MenuItem, Paper, Select, TextField, Typography, Alert } from "@mui/material";
...
class CreateNewMessage extends Component {
    ...
    render() {
        ...
        return (
            ...
            localStorage.getItem("userStatus").includes("1") ?
                (
                    <div>
                ...
                <Grid item>
                    <Box>
                        <Alert variant="filled" severity="info">Negalite sukurti naujo pranešimo, nes neturite sutarties arba jos dar nepasirašėte</Alert>
                    </Box>
                </Grid>
